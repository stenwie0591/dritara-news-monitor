...
| R-002 | corruzione/perdita durante migrazione DB legacy | M/H | baseline/fingerprint sintetici M02.01; restano preflight, backup API, checksum, dry-run copia e restore | tech/ops | M02 | open/base-controls |
