...
| ID | Stato | Outcome/deliverable | Dipendenze | DoD specifica |
|---|---|---|---|---|
| M02.01 | proposed | Alembic baseline e fixture legacy | M01 | Fresh upgrade, fingerprint/stamp/legacy upgrade e secondo upgrade no-op passano su fixture sintetica versionata. |
